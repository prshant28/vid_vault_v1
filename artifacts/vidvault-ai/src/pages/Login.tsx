...
const AI_TASKS = [
  {
    ...
    icon: FileText,
    color: "#8b5cf6",
    result: "847-word structured summary",
  },
  {
    label: "Flashcard Deck",
    icon: Brain,
    color: "#06b6d4",
    result: "14 spaced-repetition cards",
  },
  {
    label: "MCQ Set",
    icon: CheckSquare,
    color: "#22c55e",
    result: "12 auto-graded questions",
  },
  {
    label: "Blog Article",
    icon: FileText,
    color: "#f59e0b",
    result: "1,200-word SEO article",
  },
  {
    label: "PPT Outline",
    icon: BarChart3,
    color: "#ec4899",
    result: "8-slide deck structure",
  },
  {
    label: "Key Insights",
    icon: Sparkles,
    color: "#a78bfa",
    result: "Top 9 actionable takeaways",
  },
];
...
function LiveVideoCapture({ onSignUpNeeded }: { onSignUpNeeded: () => void }) {
  ...
  useEffect(() => {
    ...
    const pTimer = setInterval(
      () => setProgress((p) => Math.min(p + 0.18, 96)),
      90,
    );
    let td = tasksDone;
    const tTimer = setInterval(() => {
      if (td < AI_TASKS.length) {
        td++;
        setTasksDone(td);
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try {
        const r = await fetch(
          `/api/preview?url=${encodeURIComponent(trimmed)}`,
        );
      ...
      >
        <div
          ...
          style={{
            ...
            borderRadius: 18,
            boxShadow:
              "0 28px 70px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.06)",
          }}
        >
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.05] relative z-10">
            ...
            <div
              className="flex-1 flex items-center gap-2 px-3 h-8 min-w-0"
              style={{
            ...
            >
              ...
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" && phase === "previewing" && handleAdd()
                }
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              />
              <span
                className="font-mono-ui text-[8px] uppercase tracking-widest hidden sm:block"
                style={{
                  color:
                    phase === "added"
                      ? "#22c55e"
          ...
          <div className="relative z-10">
            ...
            {phase === "idle" && inputUrl && (
              ...
              >
                ...
                <span className="font-mono-ui text-[10px] text-[#333] uppercase tracking-wider">
                  NOT A VALID URL
                </span>
                <span className="font-mono-ui text-[9px] text-[#222]">
                  Try: youtube.com/... or any https:// link
                </span>
              </motion.div>
            )}
              ...
              >
                ...
                >
                      ...
                      {ogLoading && (
                        ...
                        >
                          <div className="flex flex-col items-center gap-2">
                            ...
                            <span className="font-mono-ui text-[9px] text-[#444] uppercase tracking-widest">
                              Fetching Preview...
                            </span>
                          </div>
                        </motion.div>
                      ...
                      {!ogLoading && ogData && !ogData.image && (
                        ...
                        >
                          ...
                          <div className="text-center">
                            <p
                              className="font-bold text-white text-xs leading-snug line-clamp-2"
                              style={{ fontFamily: "'Raleway', sans-serif" }}
                            >
                              {ogData.title}
                            </p>
                            <p className="font-mono-ui text-[9px] text-[#555] mt-1">
                              {ogData.domain}
                            </p>
                          </div>
                        </motion.div>
                  ...
                  <motion.div
                    ...
                    style={{
                      background:
                        "linear-gradient(transparent, rgba(0,0,0,0.97))",
                    }}
                    animate={{
                  ...
                  >
                    ...
                    <div
                      className="w-full h-1.5 rounded-full mb-2 cursor-pointer group/bar relative"
                    ...
                    >
                      <motion.div
                        className="h-full rounded-full overflow-visible"
                      ...
                      >
                        <div
                          className="absolute right-0 top-1/2 w-3 h-3 rounded-full bg-white opacity-0 group-hover/bar:opacity-100 transition-opacity"
                          style={{
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Volume2
                        className="w-3.5 h-3.5 text-white/50 hover:text-white cursor-pointer transition-colors"
                ...
                <div className="px-4 py-2.5 border-b border-white/[0.05] flex items-start justify-between gap-2">
                  <div className="flex-1 min-w-0">
                    <p
                      className="font-bold text-xs text-white leading-snug truncate"
                      style={{ fontFamily: "'Raleway', sans-serif" }}
                    >
                      {activeTitle}
                    </p>
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      {phase === "demo" && (
                        <>
                          <span className="text-[#222] font-mono-ui text-[8px]">
                            •
                          </span>
                          <span className="font-mono-ui text-[9px] text-[#333]">
                  ...
                  {phase === "demo" && (
                    <span className="font-mono-ui text-[7px] text-[#1e1e1e] uppercase tracking-widest mt-0.5 flex-shrink-0">
                      DEMO
                    </span>
                  )}
                </div>
                  ...
                  {phase === "previewing" && addStatus !== "needsAuth" && (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {addStatus === "error" && (
                          <span className="font-mono-ui text-[9px] text-red-400">
                            ERR: {addError}
                          </span>
                        )}
                      </div>
                  ...
                  {addStatus === "needsAuth" && (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className="font-bold text-[12px] text-white mb-0.5"
                            style={{ fontFamily: "'Raleway', sans-serif" }}
                          >
                            Sign in to save this video
                          </p>
                          <p className="font-mono-ui text-[9px] text-[#444] mb-3">
                            Create a free account or log in to add videos to
                            your vault.
                          </p>
                  ...
                  {phase === "added" && (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p
                          className="font-bold text-[12px] text-green-400"
                          style={{ fontFamily: "'Raleway', sans-serif" }}
                        >
                          Video Added to Vault!
                        </p>
                        <p className="font-mono-ui text-[9px] text-[#444] mt-0.5">
                          AI analysis queued. Opening library...
                        </p>
                      </div>
                      <a
                        href="/"
                ...
                <div className="px-4 py-3">
                  <div className="flex items-center gap-2 mb-2.5">
                    ...
                    <span className="font-mono-ui text-[9px] text-[#8b5cf6] uppercase tracking-widest">
                      AI_GENERATION_SUITE
                    </span>
                    ...
                    {AI_TASKS.map((task, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          animate={{ opacity: done || active ? 1 : 0.22, y: 0 }}
                          ...
                          style={{
                            ...
                            border: `1px solid ${done ? `${task.color}28` : "rgba(255,255,255,0.03)"}`,
                            borderRadius: 8,
                            transition: "all 0.3s",
                          }}
                        >
                          ...
                          <div className="flex flex-col min-w-0">
                            ...
                            {done && (
                              <motion.span
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="font-mono-ui text-[7px] truncate"
                                style={{ color: task.color }}
                              >
                                {task.result}
                              </motion.span>
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-evenly py-4 min-h-0">
        {NAV_ITEMS.map((item, i) => (
          ...
          >
            <span
              className="font-mono-ui text-[8px] uppercase tracking-[0.25em] transition-all duration-200"
              style={{ color: active === item.id ? "#8b5cf6" : "var(--vv-text-muted)" }}
            >
              {item.label}
            </span>
            {active === item.id && (
...
function TopBar({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <span
          className="font-black lp-heading uppercase text-base sm:text-lg"
          style={{
            fontFamily: "'Alegreya Sans SC', serif",
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        <button
          onClick={onLogin}
          className="text-[11px] uppercase tracking-widest text-[#3a3a3a] hover:text-[#8b5cf6] transition-colors font-semibold"
          style={{ fontFamily: "'Raleway', sans-serif" }}
        >
          LOG IN
        </button>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="badge-mono mb-5 block w-fit text-[10px]">{children}</span>
  );
}
  ...
  const cards = [
    {
      icon: Youtube,
      title: "SAVE VIDEOS",
      desc: "Paste any YouTube URL or playlist. Import up to 500 videos instantly with full metadata.",
      color: "#ef4444",
    },
    {
      icon: Folder,
      title: "SMART FOLDERS",
      desc: "Organize with nested folders and color-coded tags. Zero friction, full control.",
      color: "#f59e0b",
    },
    {
      icon: Sparkles,
      title: "AI GENERATION",
      desc: "6 AI tools: summaries, flashcards, MCQ, outlines, insights, blog posts.",
      color: "#8b5cf6",
    },
    {
      icon: Download,
      title: "EXPORT ANYWHERE",
      desc: "Export to PDF, Markdown, JSON, PPT. Or share a public link instantly.",
      color: "#06b6d4",
    },
    {
      icon: Brain,
      title: "FLASHCARD DECKS",
      desc: "Auto-generated spaced-repetition flashcards from any video transcript.",
      color: "#10b981",
    },
    {
      icon: BarChart3,
      title: "KNOWLEDGE GRAPH",
      desc: "Visual graph of your saved videos, tags, and AI-generated connections.",
      color: "#ec4899",
    },
  ];
  return (
    <section ref={ref} className="py-20 sm:py-28 px-8 sm:px-14">
      ...
      <div className="overflow-hidden mb-12">
        ...
        >
          The Core
          <br />
          <span className="text-outline-strong">Protocols.</span>
        </motion.h2>
      </div>
        ...
        {cards.map((card, i) => (
          ...
          >
            <div
              ...
              style={{
                background: `radial-gradient(circle, ${card.color}1a 0%, transparent 70%)`,
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span
                className="font-black text-[12px] uppercase tracking-wide lp-heading"
                style={{ fontFamily: "'Raleway', sans-serif" }}
              >
                {card.title}
              </span>
  ...
  const tools = [
    {
      id: "01",
      label: "AI SUMMARY",
      desc: "Full-length structured summary with key points and timestamps.",
      color: "#8b5cf6",
    },
    {
      id: "02",
      label: "FLASHCARDS",
      desc: "Spaced-repetition ready Q&A deck generated from the video.",
      color: "#06b6d4",
    },
    {
      id: "03",
      label: "MCQ SET",
      desc: "Auto-graded multiple-choice quiz from any topic in the video.",
      color: "#22c55e",
    },
    {
      id: "04",
      label: "BLOG ARTICLE",
      desc: "SEO-optimized article written from the video transcript.",
      color: "#f59e0b",
    },
    {
      id: "05",
      label: "PPT OUTLINE",
      desc: "Slide-by-slide presentation structure ready to export.",
      color: "#ec4899",
    },
    {
      id: "06",
      label: "KEY INSIGHTS",
      desc: "Bullet-point critical takeaways extracted for quick review.",
      color: "#a78bfa",
    },
  ];
  return (
    <section
      ref={ref}
      className="py-20 sm:py-28 px-8 sm:px-14"
      style={{ borderTop: "1px solid var(--vv-border-section)" }}
    >
      ...
      <div className="overflow-hidden mb-12">
        <motion.h2
          ...
          animate={inView ? { y: 0, opacity: 1 } : {}}
          transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] }}
          className="font-black lp-heading leading-[0.88]"
          style={{
            fontSize: "clamp(2.2rem, 5vw, 5rem)",
            fontFamily: "'Alegreya Sans SC', serif",
            letterSpacing: "-0.01em",
        ...
        >
          6 AI Tools.
          <br />
          <span className="text-outline-strong">One Vault.</span>
        </motion.h2>
      </div>
      <div className="space-y-px">
        {tools.map((tool, i) => (
          <motion.div
            ...
            style={{
              borderBottom: "1px solid var(--vv-border-section)",
              borderRadius: 4,
            }}
          >
            <span
              className="font-mono-ui text-[10px] font-black w-7 flex-shrink-0"
            ...
            <div
              ...
              style={{ background: `${tool.color}40` }}
            />
            <span
              className="font-black text-sm uppercase tracking-wide lp-heading w-36 sm:w-44 flex-shrink-0 transition-colors"
              style={{ fontFamily: "'Raleway', sans-serif" }}
            >
              {tool.label}
            </span>
            <span
              className="text-[14px] text-[#333] flex-1 hidden sm:block leading-relaxed"
              style={{ fontFamily: "'Raleway', sans-serif" }}
            >
              {tool.desc}
            </span>
            <div
              className="w-7 h-7 flex items-center justify-center flex-shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-200"
  ...
  const steps = [
    {
      n: "01",
      title: "Paste URL",
      desc: "Drop any YouTube link or playlist. Supports single videos and playlists up to 500 items.",
      icon: Youtube,
      color: "#8b5cf6",
    },
    {
    ...
    },
    {
      n: "03",
      title: "Get Knowledge",
      desc: "Download 6 AI artifacts — summaries, flashcards, MCQs, articles, outlines, and insights.",
      icon: BookOpen,
      color: "#10b981",
    },
  ];
    ...
    >
      ...
      <div className="overflow-hidden mb-16">
        ...
        >
          Three Steps.
          <br />
          <span className="text-outline-strong">Infinite Knowledge.</span>
        </motion.h2>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {steps.map((step, i) => (
          ...
          >
            <div
              className="text-[72px] font-black absolute -top-3 -right-1 opacity-[0.035] pointer-events-none select-none leading-none"
              style={{
                fontFamily: "'Alegreya Sans SC', serif",
                color: step.color,
              }}
            ...
            >
              ...
              <span
                className="absolute -top-1.5 -right-1.5 font-black text-black text-[9px] px-1.5 py-0.5"
                style={{
                  background: "#fff",
                  borderRadius: 4,
                  fontFamily: "'Raleway', sans-serif",
            ...
            <h3
              className="font-black lp-heading text-xl mb-2"
...
function GetStartedSection({ onRegister }: { onRegister: () => void }) {
  ...
  return (
    <section
      ref={ref}
      className="py-20 sm:py-32 px-8 sm:px-14"
      style={{ borderTop: "1px solid var(--vv-border-section)" }}
    >
      <div className="max-w-2xl">
        ...
        <div className="overflow-hidden mb-6">
          ...
          >
            Build Your
            <br />
            <span className="text-outline-strong">Second Brain.</span>
          </motion.h2>
        </div>
        <motion.p
          initial={{ opacity: 0 }}
          ...
          className="text-[16px] text-[#3a3a3a] mb-8 leading-relaxed max-w-md"
          style={{ fontFamily: "'Raleway', sans-serif" }}
        >
          Join thousands of students and creators who use VidVault AI to turn
          YouTube into structured, searchable knowledge.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          <span className="font-mono-ui text-[9px] text-[#1e1e1e] uppercase tracking-widest">
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              background: node.primary
                ...
                : "#0f0f12",
              border: `1px solid ${node.primary ? "rgba(139,92,246,0.6)" : "rgba(139,92,246,0.12)"}`,
              borderRadius: node.primary ? 12 : 8,
              boxShadow: node.primary
                ? "0 0 28px rgba(139,92,246,0.3)"
                : "none",
              color: node.primary ? "#fff" : "#8b5cf6",
              fontSize: node.primary ? "11px" : "8px",
            }}
          >
            {node.label.slice(0, 3)}
          </div>
          <span className="font-mono-ui text-[7px] text-[#222] uppercase tracking-widest">
            {node.label}
          </span>
        </motion.div>
      ))}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: "linear-gradient(to right,#0a0a0b 0%,transparent 10%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "linear-gradient(to bottom,#0a0a0b 0%,transparent 8%,transparent 88%,#0a0a0b 100%)",
        }}
      />
    </div>
  );
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries) =>
        entries.forEach((e) => {
          if (e.isIntersecting) {
            const id = e.target.getAttribute("data-section") as NavSection;
  ...
  return (
    <div
      ...
      style={{ background: "var(--vv-bg)", color: "var(--vv-text)", minHeight: "100vh" }}
    >
      <motion.div
        className="fixed w-[360px] h-[360px] rounded-full pointer-events-none z-0"
        style={{
          x: glowX,
          y: glowY,
          background:
      ...
      <AnimatePresence mode="wait">
        ...
        {mode === "landing" && (
          ...
          >
            ...
            >
              <div
                className="grid-mesh absolute inset-0 pointer-events-none z-0"
                style={{ left: SIDEBAR_W }}
              />

              <TopBar
                onLogin={() => setMode("login-manual")}
              ...
              >
                ...
                <div className="flex flex-col justify-center px-8 sm:px-12 lg:px-14 py-14 lg:py-0 lg:w-[48%] flex-shrink-0">
                  ...
                  >
                    <span className="badge-mono mb-5 block w-fit">
                    ...
                    {["SAVE.", "ANALYZE.", "MASTER."].map((word, i) => (
                      <div key={word} className="overflow-hidden">
                        <motion.h1
                          ...
                          initial="hidden"
                          animate="visible"
                          className={`font-black leading-[0.88] uppercase ${i === 1 ? "text-outline-strong" : "lp-heading"}`}
                          style={{
                  ...
                  >
                    <TypedText
                      text="Save YouTube videos. Generate AI summaries, flashcards & MCQs. Build your knowledge vault."
                      startDelay={700}
                    />
                  </motion.p>
                  ...
                  >
                    {[
                      ...
                      <div key={s.label} className="flex flex-col">
                        ...
                        <span className="font-mono-ui text-[7px] text-[#1e1e1e] uppercase tracking-widest mt-1">
                          {s.label}
                        </span>
                      </div>
                    ))}
                ...
                <div
                  className="flex-1 border-l hidden lg:flex items-center overflow-hidden"
                  style={{ borderColor: "rgba(255,255,255,0.04)" }}
                >
                  <LiveVideoCapture
                    onSignUpNeeded={() => setMode("register")}
                  />
                </div>
              ...
              <div
                ref={(el) => {
                  sectionRefs.current.AI_TOOLS = el;
                }}
                data-section="AI_TOOLS"
              >
                <AIToolsSection />
              </div>
              <div
                ref={(el) => {
                  sectionRefs.current.HOW_IT_WORKS = el;
                }}
              ...
              <div
                ref={(el) => {
                  sectionRefs.current.GET_STARTED = el;
                }}
                data-section="GET_STARTED"
              >
                <GetStartedSection onRegister={() => setMode("register")} />
              </div>

              <footer
                className="px-8 sm:px-14 py-6 border-t flex items-center justify-between"
                style={{ borderColor: "var(--vv-border-section)", marginLeft: 0 }}
              >
                <span className="font-mono-ui text-[8px] text-[#1a1a1a] uppercase tracking-widest">
                  © 2026 VIDVAULT AI
                </span>
                <span className="font-mono-ui text-[8px] text-[#1a1a1a] uppercase tracking-widest">
                  VV_CORE_v2.0
        ...
        {(mode === "register" || mode === "login-manual") && (
          ...
          >
            ...
            <div className="flex flex-col flex-1 lg:max-w-[50%]">
              <header
                className="flex items-center justify-between px-8 sm:px-10 h-14 sm:h-16 flex-shrink-0"
                style={{ borderBottom: "1px solid var(--vv-border-section)" }}
              >
                <div className="flex items-center gap-2">
                  <div
                    className="w-8 h-8 flex items-center justify-center font-black text-black text-[11px]"
                    style={{
                      fontFamily: "'Alegreya Sans SC', serif",
                      background: "#fff",
                      borderRadius: 5,
              ...
              <div className="flex-1 flex items-center justify-center px-8 py-10">
                <div className="w-full max-w-sm">
                  <motion.div
                    ...
                    className="mb-8"
                  >
                    <span className="badge-mono mb-3 block w-fit">
                  ...
                  <motion.form
                    ...
                    onSubmit={
                      mode === "register" ? handleRegister : handleManualLogin
                    }
                    className="space-y-4"
                  >
                    {mode === "register" && (
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          <label className="font-mono-ui text-[9px] uppercase tracking-widest text-[#282828]">
                            FIRST NAME
                          </label>
                          <MonoInput
                            placeholder="John"
                  ...
                  >
                    ...
                    <p className="mt-5 font-mono-ui text-[9px] lp-desc uppercase tracking-widest text-center">
                      ...
                      <button
                        onClick={() => {
                          setMode(
                            mode === "register" ? "login-manual" : "register",
                          );
                          setError("");
                        }}
                        className="text-[#8b5cf6] hover:text-[#a78bfa] transition-colors"
