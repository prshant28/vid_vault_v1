...
const styles = StyleSheet.create({
  ...
  headerMicro: { fontFamily: "Poppins_400Regular", fontSize: 8, letterSpacing: 2, marginBottom: 1 },
  headerTitle: { fontFamily: "AlegreyaSansSC_800ExtraBold", fontSize: 18, letterSpacing: -0.3 },
  sub: { fontFamily: "Poppins_400Regular", fontSize: 11, paddingHorizontal: 20, marginTop: 12, marginBottom: 16 },
  list: { flex: 1 },
  ...
  badgeText: { fontFamily: "Poppins_600SemiBold", fontSize: 9, letterSpacing: 1.5 },
  cardBody: { gap: 3 },
  cardName: { fontFamily: "Poppins_700Bold", fontSize: 15 },
  cardDesc: { fontFamily: "Poppins_400Regular", fontSize: 11 },
  ...
  previewBtnText: { fontFamily: "Poppins_600SemiBold", fontSize: 11 },
  footer: {
    padding: 20,
  ...
  footerMicro: { fontFamily: "Poppins_400Regular", fontSize: 8, letterSpacing: 1.5, marginBottom: 1 },
  footerInfoText: { fontFamily: "Poppins_600SemiBold", fontSize: 12 },
  exportBtn: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 18, paddingVertical: 12, borderRadius: 12 },
  exportBtnText: { fontFamily: "Poppins_700Bold", fontSize: 14, color: "#fff" },
  ...
  previewCloseText: { fontFamily: "Poppins_400Regular", fontSize: 13 },
  previewTitle: { fontFamily: "Poppins_700Bold", fontSize: 14 },
  previewExport: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
  previewExportText: { fontFamily: "Poppins_700Bold", fontSize: 13, color: "#fff" },
  loadingOverlay: {
    position: "absolute",
    top: 100,
    left: 0,
