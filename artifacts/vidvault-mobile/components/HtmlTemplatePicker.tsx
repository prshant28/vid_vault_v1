...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: "Poppins_600SemiBold", fontSize: 16, color: "#fff", letterSpacing: 0.5 },
  sub: { fontFamily: "Poppins_400Regular", fontSize: 11, color: "#666", paddingHorizontal: 20, marginBottom: 16 },
  list: { flex: 1 },
  ...
  cardDesc: { fontFamily: "Poppins_400Regular", fontSize: 11, color: "#666" },
  ...
  previewCloseText: { fontFamily: "Poppins_400Regular", fontSize: 13, color: "#fff" },
  ...
  loadingText: { fontFamily: "Poppins_400Regular", fontSize: 12, color: "#666" },
  webview: { flex: 1 },
});
