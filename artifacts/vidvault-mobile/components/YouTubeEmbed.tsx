  ...
  if (error) {
    return (
      <View style={[styles.player, styles.errCenter]}>
        ...
        <TouchableOpacity onPress={onOpenExternal} style={styles.errBtn} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  errSub: {
    ...
    fontFamily: "Poppins_400Regular", textAlign: "center", marginTop: 4,
  },
  errBtn: {
    flexDirection: "row", alignItems: "center", gap: 8,
    paddingHorizontal: 20, paddingVertical: 10,
    backgroundColor: "#ef4444", borderRadius: 6, marginTop: 12,
  },
  errBtnText: { color: "#fff", fontSize: 10, fontFamily: "JetBrainsMono_400Regular", letterSpacing: 1.2 },
  ytExtBtn: {
