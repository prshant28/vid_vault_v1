...
function AiOutputPanel({ output, tool, videoTitle, onClose, onRegenerate, lang, onLangChange }: {
  ...
  const EXPORT_OPTIONS = [
    { icon: "copy" as FeatherIconName,    label: "Copy to Clipboard",  desc: "Paste anywhere",                  color: "#22c55e", action: handleCopy },
    ...
    >
      ...
      <View style={[styles.outputFullHeader, { paddingTop: insets.top + 10 }]}>
        ...
        <View style={{ flexDirection: "row", gap: 8 }}>
          ...
          >
            <Feather name="download" size={14} color={tool.color} />
          </TouchableOpacity>
        </View>
      </View>
