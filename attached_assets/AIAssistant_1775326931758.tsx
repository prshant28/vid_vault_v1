...
export default function AIAssistant() {
  ...
  return (
    <div
      className="flex h-[calc(100vh-3.5rem-4rem)] lg:h-[calc(100vh-3.5rem)] gap-0 rounded-xl overflow-hidden -mx-4 sm:-mx-6 lg:-mx-8 -mb-4 sm:-mb-6 lg:-mb-8"
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 hide-scrollbar">
          {messages.length === 0 && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="flex flex-col items-center justify-center min-h-[260px] py-8 text-center gap-6"
            >
              <div>
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mx-auto mb-3"
                  style={{ background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)" }}>
                  <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 text-[#8b5cf6]" />
                </div>
